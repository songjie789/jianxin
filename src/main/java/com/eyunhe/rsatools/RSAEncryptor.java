...
public class RSAEncryptor {
   ...
   public void JiaMiJieMi(String test) throws Exception{  

        String publicKeyPath = "F:/password/rsa_public_key.pem";        // replace your public key path here
        String privateKeyPath =  "F:/password/pkcs8_private_key.pem";     // replace your private path here
        RSAEncryptor rsaEncryptor = new RSAEncryptor(publicKeyPath, privateKeyPath);
   ...
   //加密过程
   public String JiaMi(String test) throws Exception{
	   String publicKeyPath = "F:/password/rsa_public_key.pem";  
	   RSAEncryptor rsaEncryptor = new RSAEncryptor(publicKeyPath);
	   String testRSAEnWith64 = rsaEncryptor.encryptWithBase64(test);
	   return testRSAEnWith64;
   }
   //解密过程
   public String JieMi(String testRSAEnWith64) throws Exception{
	   
	   RSAEncryptor rsaEncryptor = new RSAEncryptor();
	   rsaEncryptor.JieMiMoNiGouZao();
	   String testRSADeWith64 = rsaEncryptor.decryptWithBase64(testRSAEnWith64);
     ...
     */
   public RSAEncryptor(String publicKeyFilePath) throws Exception{
	   String public_key = getKeyFromFile(publicKeyFilePath);
	   loadPublicKey(public_key);  
   }
   public void JieMiMoNiGouZao() throws Exception{
	   String privateKeyPath = "F:/password/pkcs8_private_key.pem";
    ...
    public String encryptWithBase64(String string) throws Exception {
        ...
        //System.out.println("我是base64String:"+base64String);
        return base64String;
    }
    ...
    public void loadPublicKey(String publicKeyStr) throws Exception{  
        try {  
            ...
            X509EncodedKeySpec keySpec= new X509EncodedKeySpec(buffer);  		//规范  用X.509标准作为密钥规范管理的编码格式*(公钥字符串)
            this.publicKey= (RSAPublicKey) keyFactory.generatePublic(keySpec);  //工厂获取规范后的公钥字符串
    ...
    public byte[] encrypt(RSAPublicKey publicKey, byte[] plainTextData) throws Exception{  
        ...
        try {  
            ...
            System.out.println("加密之后的数字是："+output+")ppppppp");
            return output;  
        } catch (NoSuchAlgorithmException e) {  
